...
public class SimulationP2P extends Simulation<EnvironmentP2P, CommandP2P>
{
	...
	public SimulationP2P()
	{
		...
		layout.addRow(new String[] { base.graphics.ViewerFactory.Type.AGENT_SELECTION_GRID.toString(),
				base.graphics.ViewerFactory.Type.ITEM_GRAF.toString(),
				base.graphics.ViewerFactory.Type.ITEM_LOCATION_GRAF.toString(),
				base.graphics.ViewerFactory.Type.ITEM_WANTED_GRAF.toString(), });
		...
		viewers = ViewerFactoryP2P.createViewers(environment, layout.getAllWindows());
		init2();
	}
