...
public class Simulation extends JFrame implements Runnable, UpdateListener
{
	/**
	 * 
	 */
...
//	 private Scenario scenario = new Scenario("test/testSmall2.xml");
	Scenario				scenario	= new Scenario("test/test3r_save.xml");
...
//		WindowLayout layout = new WindowLayout(70, 0, 1600, 1000, 15, 1, 5, true, true); // larger (1680), windows 7
	...
	public static Simulation getKca() {
		return kca;
	}


	public static void setKca(Simulation kca1) {
		Simulation.kca = kca1;
